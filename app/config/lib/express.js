...
module.exports.initLocalVariables = function(app) {
    console.log('Initializing LocalVariables...');
...
module.exports.initModulesConfiguration = function(app, db) {
    console.log('Initializing Modules Configuration...');
...
//     config.log('Initializing Helmet Headers...');
...
//     config.log('Initializing Modules Client Routes...');
...
module.exports.initModulesServerRoutes = function(app) {
    console.log('Initializing Modules Server Routes...');
...
module.exports.initErrorRoutes = function(app) {
    console.log('Initializing Error Routes...');
